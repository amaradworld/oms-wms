...
export const exportInventory = async (req: AuthRequest, res: Response) => {
  ...
  const rows = items.map(i => ({
    ...
    virtualInventory: i.virtualInventory,
    notFound: i.notFound,
    reorderPoint: i.reorderPoint,
    status: i.status || 'ACTIVE',
    inventoryAllocation: i.inventoryAllocation,
    inventorySync: i.inventorySync,
    skuMixing: i.skuMixing,
    shelfOnHold: i.shelfOnHold,
