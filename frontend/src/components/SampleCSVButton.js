...
const SAMPLES = {
  ...
  inventory: 'skuCode,epcCode,name,styleName,size,color,brand,category,material,gender,unitType,mrp,hsnCode,binLocation,quantityOnHand\nTSH-BLU-L,10000000001,Blue Cotton T-Shirt (L),Classic Fit T-Shirt,L,Blue,NoName,Apparel,Cotton,Male,Pieces,999,6109,BIN-01,50\nSHK-BLK-10,10000000002,Black Running Shoes (10),Air Run 2000,10,Black,SportWear,Footwear, Mesh,Male,Pair,4499,6403,BIN-15,30',
