    ...
    <div className="p-8 space-y-6 max-w-4xl mx-auto">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500">Order #ORD-1042 • Customer: Priya Sharma</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-4">
            ...
            <div className="divide-y">
              <div className="flex items-center justify-between py-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm">TSH-BLU-M • Blue T-Shirt (M)</p>
                    <p className="text-xs text-slate-400">Bin: BIN-42 • Qty: 2</p>
                  </div>
                </div>
                <span className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full">Packed</span>
              </div>
              <div className="flex items-center justify-between py-3">
                <div className="flex items-center gap-3">
                  <PackageCheck size={18} className="text-green-500" />
                  <div>
                    <p className="font-medium text-sm">JNS-BLK-32 • Black Jeans (32)</p>
              ...
              <div className="flex items-center justify-between py-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm">ACC-WLT-BRW • Brown Wallet</p>
          ...
          <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
            <form onSubmit={handleScan} className="flex gap-3">
              <input
                autoFocus
                className="flex-1 px-4 py-3 border-2 rounded-xl font-mono outline-none focus:ring-4 focus:ring-blue-200"
                placeholder="Scan SKU to verify packing..."
                value={scanInput}
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm">
            ...
            {packedItems.length === 0 ? (
              <div className="p-6 text-center text-slate-400">No scans yet</div>
            ) : (
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm h-fit">
          <h3 className="font-bold mb-4">Packing Summary</h3>
